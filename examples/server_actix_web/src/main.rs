...
async fn ping(body: PingRequest, request: HttpRequest) -> Result<Json<PingResponse>, ServerError> {
...
async fn hello(body: HelloRequest, request: HttpRequest) -> Result<Json<HelloResponse>, ServerError> {
